            ...
            >
              <div class="flex-1">
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400">
                  We use Google Analytics 4 and GoatCounter for anonymous visit statistics to
                  improve the site. Your data is never sold. You can accept all cookies, only
                  necessary ones, or reject everything. Read our
                  <NuxtLink
                    to="/privacy"
